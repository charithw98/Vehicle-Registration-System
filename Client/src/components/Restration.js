...
const Restration = () => {
  ...
  const onSubmit = async (e) => {
    ...
    if (form.checkValidity() === false) {
      ...
      e.preventDefault();
      await axios.post(
        "http://localhost:8000/register/newregistration",
        vehicle
      );
      ...
      <div>
        ...
        <div className="container">
          <div
            ...
            style={{ backgroundColor: "hsl(120,100%,25%,0.4)" }}
          >
            <h2 className="text-center mb-5">
              V e h i c l e ___ R e g i s t r a t i o n
            </h2>
            ...
            >
              ...
              <div className="form-group row">
                ...
                <div class="col-sm-8" onChange={(e) => onInputChange(e)}>
                  <input type="radio" value="Petrol" name="fuelUsed" required />
                  &nbsp; Petrol&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input type="radio" value="Disel" name="fuelUsed" required />
                  &nbsp; Disel
                  <Form.Control.Feedback type="invalid">
