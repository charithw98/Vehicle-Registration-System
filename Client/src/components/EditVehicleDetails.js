      ...
      <div>
        ...
        <div className="container">
          <div
            ...
            style={{ backgroundColor: "hsl(0,100%,25%,0.4)" }}
          >
            <h2 className="text-center mb-5">
              V e h i c l e ___ D e t a i l s ___ U p d a t e
            </h2>
